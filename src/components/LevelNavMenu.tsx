...
export const LevelNavMenu = ({levels, current_level_index, highest_unlocked_level, show_level_nav, page}: {
  ...
  return(
    <div className={`LevelNavMenu primary-content-container ${show_level_nav ? 'show' : 'hide'}`}>
      <div className='row'>
      ...
      <span className='flat-button clickable' onClick={toggleLevelNavMenu}>Back to game ↩</span>
    </div>
  );
}
